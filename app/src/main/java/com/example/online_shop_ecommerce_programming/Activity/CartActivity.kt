...
import com.example.online_shop_ecommerce_programming.Helper.ChangeNumberItemsListener
...
fun CartItem(
    ...
    ConstraintLayout(
        ...
        val (pic, titleTxt, feeEachTime, totalEachItem, Quanty) = createRefs()
        Image(
        ...
        ConstraintLayout(modifier = Modifier
            ...
            Box(modifier = Modifier
                ...
                .clickable {
                    managmentCart.plusItem(cartItems, cartItems.indexOf(item), object : ChangeNumberItemsListener {
